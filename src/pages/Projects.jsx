  ...
  const projects = [
    {
      ...
      description:
        "Detecting AI-Generated Images with Explainable Deep Learning",
      longDescription:
        "A full-stack AI-powered platform that accurately identifies whether an image is AI-generated or real using a ConvNeXt-based deep learning model, complete with explainable Grad-CAM visualizations, authentication, and analysis history tracking.",
      features: [
        "High-accuracy AI image detection using ConvNeXt architecture",
        "Grad-CAM heatmaps for explainable AI predictions",
        "Secure user authentication and profile-based history tracking",
        "Image upload, analysis dashboard, and result visualization",
        "Cloud-based image storage and scalable inference pipeline",
      ],
      tech: [
        "React.js",
        "Node.js",
      ...
      github: "https://github.com/ayushman-svnit/genesis",
      demo: "https://genesis-rose-rho.vercel.app/",
      status: "Completed",
      icon: <Brain />,
    },
